...
//elemento : que elementos necesito elejir del dom
//evento: que operacion necesito realizar.
//ejecucion: presento el resultado.

const valorInput = '';
const resultFToC = '';

const fToC = {
  f: parseFloat(valorInput),
  resultFToC() {
    const C = (this.f - 32) / 1.8;
  },
  return(C),
}
const arrayBoton = document.querySelectorAll(button);
