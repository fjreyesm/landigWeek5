...
let operation1 = (resultado1) => (resultado1 - 32) / 1.8;
let operation2 = (resultado2) => resultado2 * 1.8 + 32;

let button1 = document.getElementById("fahrenheit_to_celsius");
let button2 = document.getElementById("celsius_to_fahrenheit");
button1.addEventListener("click", function resul1() {
  document.getElementById("result").innerText = operation1(
    document.getElementById("temperature").value
  );
  document.getElementById("temperature").value = "";
});
button2.addEventListener("click", function resul2() {
